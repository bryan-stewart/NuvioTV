...
class TrackingSourceController @Inject constructor(
    ...
    private suspend fun applyWatchProgressSource(source: WatchProgressSource, profileId: String) {
    ...
    private suspend fun applyLibrarySourceMode(mode: LibrarySourceMode, profileId: String) {
    ...
    private suspend fun repopulateWatchedItemsFromNuvioSync(profileId: String) {
        runCatching {
